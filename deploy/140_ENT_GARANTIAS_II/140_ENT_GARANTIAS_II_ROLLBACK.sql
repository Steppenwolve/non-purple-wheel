...
IF EXISTS (
    ...
    DROP TABLE [LMDA].[GARANTIAS_II];
PRINT '>> BRONZE.[LMDA].[GARANTIAS_II] eliminada (si existia).';
GO
...
BEGIN
    EXEC sp_rename '[RR].[140_ENT_GARANTIAS_II].[FECHAINFO]', 'FECHA_REPORTE', 'COLUMN';
...
BEGIN
    ...
    DECLARE @NombreJob NVARCHAR(128) = '[140_ENT_GARANTIAS_II] ';
    ...
    BEGIN TRY
        ...
        IF EXISTS (SELECT ID FROM [SILVER].[RR].[140_ENT_GARANTIAS_II]
        ...
        INSERT INTO [RR].[140_ENT_GARANTIAS_II] (
            ...
            [CVE_TIT],[EMI_ACT],[FE_AV_BI],[RE_BM_BI],[AFORO],[VAL_GTA],[MDA_GTA],[FECHA_REPORTE]
        )
        SELECT [OFICINA],[CONT],[ID_GAR],[CON_GTA],[POS_GTA],[TIP_GTA],
               [CVE_TIT],[EMI_ACT],[FE_AV_BI],[RE_BM_BI],[AFORO],[VAL_GTA],[MDA_GTA],
...
END;
GO
PRINT '>> Restaurado SILVER.dbo.[140_ENT_GARANTIAS_II] (SP original).';
GO
...
END;
GO
PRINT '>> Restaurado ION.dbo.[140_ENT_GARANTIAS_II] (SP original).';
GO
PRINT '>> Rollback 140_ENT_GARANTIAS_II completado.';
GO
